...
public class Topic_09_Handle_Custom_Dropdown {
	...
	public void beforeClass() {
		...
		// Wait cho các element theo điều kieẹn có sẵn : visible / invisible / presence / clickable / ....
	...
	public void TC_04_NoEcommerce_Default_Dropdown() {
	    ...
	    Assert.assertTrue(driver.findElement(By.xpath("//select[@name='DateOfBirthDay']/option[text()='20']")).isSelected()); 
	}
